    ...
    def get_contacts(self):
        for country in self.country_names:
            ...
            for contact in contacts:
                ...
                c[0, 0] = t_contact[0, 0]
                c[1, 0] = np.sum(t_contact[age[1][0]:(age[1][1]+1), age[0][0]:(age[0][1]+1)])
                c[2, 0] = t_contact[3, 0]
                c[3, 0] = t_contact[4, 0]
                c[4, 0] = np.sum(t_contact[age[4][0]:(age[4][1] + 1), age[0][0]:(age[0][1] + 1)])
                c[5, 0] = np.sum(t_contact[age[5][0]:(age[5][1] + 1), age[0][0]:(age[0][1] + 1)])
                ...
                c[1, 1] = np.sum(t_contact[age[1][0]:(age[1][1] + 1), age[1][0]:(age[1][1] + 1)])
                c[2, 1] = np.sum(t_contact[age[2][0]:(age[2][1] + 1), age[1][0]:(age[1][1] + 1)])
                c[3, 1] = np.sum(t_contact[age[3][0]:(age[3][1] + 1), age[1][0]:(age[1][1] + 1)])
                c[4, 1] = np.sum(t_contact[age[4][0]:(age[4][1] + 1), age[1][0]:(age[1][1] + 1)])
                c[5, 1] = np.sum(t_contact[age[5][0]:(age[5][1] + 1), age[1][0]:(age[1][1] + 1)])
                ...
                c[2, 2] = t_contact[3, 3]
                c[3, 2] = t_contact[4, 3]
                c[4, 2] = np.sum(t_contact[age[4][0]:(age[4][1] + 1), age[2][0]:(age[2][1] + 1)])
                c[5, 2] = np.sum(t_contact[age[5][0]:(age[5][1] + 1), age[2][0]:(age[2][1] + 1)])
                ...
                c[3, 3] = t_contact[4, 4]
                c[4, 3] = np.sum(t_contact[age[4][0]:(age[4][1] + 1), age[3][0]:(age[3][1] + 1)])
                c[5, 3] = np.sum(t_contact[age[5][0]:(age[5][1] + 1), age[3][0]:(age[3][1] + 1)])

                c[3, 4] = np.copy(c[4, 3])
                c[3, 5] = np.copy(c[5, 3])

                c[4, 4] = np.sum(t_contact[age[4][0]:(age[4][1] + 1), age[4][0]:(age[4][1] + 1)])
                c[5, 4] = np.sum(t_contact[age[5][0]:(age[5][1] + 1), age[4][0]:(age[4][1] + 1)])

                c[4, 5] = np.copy(c[5, 4])
                c[5, 5] = np.sum(t_contact[age[5][0]:(age[5][1] + 1), age[5][0]:(age[5][1] + 1)])

                matrix = c / self.age_group

                # aggregate the params
                # get the Probability of asymptomatic course for the age groups
                p_1 = np.sum(age_vector[age[1][0]:(age[1][1]+1), age[0][0]:(age[0][1]+1)].reshape((1, 2)) *
                             self.data.model_parameters_data['p'][1:3]) / np.sum(age_vector[1:3])
                p_2 = np.sum(age_vector[age[4][0]:(age[4][1]+1), age[0][0]:(age[0][1]+1)].reshape((1, 8)) *
                             self.data.model_parameters_data['p'][5:13]) / np.sum(age_vector[5:13])
                # self.data.model_parameters_data['p'][13:16] = [0.4, 0.3, 0.2]
                p_3 = np.sum(age_vector[age[5][0]:(age[5][1]+1), age[0][0]:(age[0][1]+1)].reshape((1, 3)) *
                             self.data.model_parameters_data['p'][13:16]) / np.sum(age_vector[13:16])

                # get the Probability of intensive care (given hospitalization) for the age groups
                x_1 = np.sum(age_vector[age[1][0]:(age[1][1] + 1), age[0][0]:(age[0][1] + 1)].reshape((1, 2)) *
                             self.data.model_parameters_data['xi'][1:3]) / np.sum(age_vector[1:3])
                x_2 = np.sum(age_vector[age[4][0]:(age[4][1] + 1), age[0][0]:(age[0][1] + 1)].reshape((1, 8)) *
                             self.data.model_parameters_data['xi'][5:13]) / np.sum(age_vector[5:13])
                # self.data.model_parameters_data['xi'][13:16] = [0.292903, 0.293624, 0.2936]
                x_3 = np.sum(age_vector[age[5][0]:(age[5][1] + 1), age[0][0]:(age[0][1] + 1)].reshape((1, 3)) *
                             self.data.model_parameters_data['xi'][13:16]) / np.sum(age_vector[13:16])

                # get the Probability of fatal outcome
                m_1 = np.sum(age_vector[age[1][0]:(age[1][1] + 1), age[0][0]:(age[0][1] + 1)].reshape((1, 2)) *
                             self.data.model_parameters_data['mu'][1:3]) / np.sum(age_vector[1:3])
                m_2 = np.sum(age_vector[age[4][0]:(age[4][1] + 1), age[0][0]:(age[0][1] + 1)].reshape((1, 8)) *
                             self.data.model_parameters_data['mu'][5:13]) / np.sum(age_vector[5:13])
                # self.data.model_parameters_data['mu'][13:16] = [0.582, 0.678, 0.687]
                m_3 = np.sum(age_vector[age[5][0]:(age[5][1] + 1), age[0][0]:(age[0][1] + 1)].reshape((1, 3)) *
                             self.data.model_parameters_data['mu'][13:16]) / np.sum(age_vector[13:16])

                # get the "Probability of hospitalization (or intensive care)"
                h_1 = np.sum(age_vector[age[1][0]:(age[1][1] + 1), age[0][0]:(age[0][1] + 1)].reshape((1, 2)) *
                             self.data.model_parameters_data['h'][1:3]) / np.sum(age_vector[1:3])
                h_2 = np.sum(age_vector[age[4][0]:(age[4][1] + 1), age[0][0]:(age[0][1] + 1)].reshape((1, 8)) *
                             self.data.model_parameters_data['h'][5:13]) / np.sum(age_vector[5:13])
                # self.data.model_parameters_data['h'][13:16] = [0.0775, 0.1788, 0.3297]
                h_3 = np.sum(age_vector[age[5][0]:(age[5][1] + 1), age[0][0]:(age[0][1] + 1)].reshape((1, 3)) *
                             self.data.model_parameters_data['h'][13:16]) / np.sum(age_vector[13:16])
